    def try_packing_list_pdf(self, request):
        ...
        def draw_header(canvas, page_number, total_pages):
            ...
            print('header_start_y', header_start_y)
        ...
        def draw_content(canvas, y_position, page_number, total_pages):
            canvas.setFont("Helvetica", 10)
            y_position = height - 3 * inch - 20  # Adjust the gap after header
            ...
            y_position -= 70  # Adjust the gap after Ship To/Bill To section
            ...
            y_position -= 20 * 3  # Reduce the gap before the master list items
